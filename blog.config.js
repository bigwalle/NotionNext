...
const BLOG = {
  ...
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || ['light', 'dark', 'auto'], // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JackYang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wuxiangyang.run', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'JackYang, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'lunckme@gmail.com', // 邮箱地址 例如mail@tangly1024.com
